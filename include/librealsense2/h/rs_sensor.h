...
/**
/* Change output pose origin on a named landmark in the map
* \param[in]  sensor    T2xx position-tracking sensor
* \param[in]  guid      Null-terminated string of up to 127 characters
...
* \return               Non-zero if succeeded, otherwise 0
*/
int rs2_change_pose_origin_on_node(const rs2_sensor* sensor, const char* guid, double* effective_time, rs2_error** error);

/**
/* Change output pose origin on a map
* \param[in]  sensor    T2xx position-tracking sensor
...
* \return               Non-zero if succeeded, otherwise 0
*/
int rs2_change_pose_origin_on_map_id(const rs2_sensor* sensor, const unsigned short mapId, double* effective_time, rs2_error** error);
